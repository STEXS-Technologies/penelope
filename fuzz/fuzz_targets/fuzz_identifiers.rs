...
use penelope_domain::{
    ActionId, CanonicalCommitId, CanonicalEventId, DefinitionId, DefinitionVersion,
    ExternalReferenceId, InputId, OperationId, OutcomeId, PrincipalId, ProcessId, ResourceId,
...
fuzz_target!(|data: &[u8]| {
    ...
    let _ = ExternalReferenceId::from_str(text);
});
